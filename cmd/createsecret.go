...
var createSecretTimeout time.Duration
...
var createSecretCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		createKafkaJaasSecret(&c, false, createSecretTimeout)
	},
}
...
func init() {
	...
	createSecretCmd.PersistentFlags().DurationVar(&createSecretTimeout, "timeout", 120*time.Second, "Timeout to wait for the target namespace to exist before creating the secret")
}
